			...
			if(isset($_POST['add'])){
				...
				for ($i = 2; $i <= $jumlah_baris; $i++) {
				    ...
				    if ($nama_barang != "" && $merek != "" && $jumlah != "" && $penjualan != "" && $kelas != "") {
				        ...
				        $upload=mysqli_query($koneksi, "INSERT into data_uji (nama_barang, merek, jumlah, penjualan, kelas_asli)values('$nama_barang', '$merek', '$jumlah', '$penjualan', '$kelas')");
				    }
				}
